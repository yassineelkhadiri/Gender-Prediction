...
# ... YOUR CODE FOR TASK 1 ...
fuzzy.nysiis("hear") == fuzzy.nysiis("here")
...
for name in author_df["nysiis_name"]:
    i = locate_in_list(list(babies_df['babynysiis']), name)
    if i == -1 :
        author_gender.append("Unknown")
    else:
        author_gender.append(babies_df["gender"][i])
...
# ... YOUR CODE FOR TASK 8 ...
plt.title("Authors gender per year")
plt.xlabel("Year")
plt.ylabel("Number of authors")
